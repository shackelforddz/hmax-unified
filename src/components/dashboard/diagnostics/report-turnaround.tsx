...
export default function ReportTurnaround() {
  ...
  return (
    <div className="bg-white rounded-xl p-5 flex flex-col">
      ...
      <div className="flex items-end justify-between gap-4 mb-5">
        <div>
          <div className="flex items-end gap-1">
            <p className="text-4xl text-gray-900 leading-none">{T.actualDays}</p>
      ...
      <p className="text-[11px] text-gray-400 uppercase tracking-wider mb-2.5">Where the time goes</p>
      <div className="flex flex-col gap-2.5">
        {T.stages.map((s) => (
          <div key={s.label} className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-700 w-12 text-right shrink-0">{s.days}d</span>
          </div>
        ))}
      </div>
